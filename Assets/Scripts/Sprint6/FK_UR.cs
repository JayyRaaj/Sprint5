...
public class RobotJointControllerr : MonoBehaviour
{
    [Header("Robot Joints")]
    ...
    private readonly float d1 = 0.15185f;
    private readonly float a2 = -0.24355f;
    private readonly float a3 = -0.2132f;
    private readonly float d4 = 0.13105f;
    private readonly float d5 = 0.08535f;
    private readonly float d6 = 0.0921f;
    ...
    public Matrix4x4 CalculateFK()
    {
        ...
        Matrix4x4 T12 = GetDHTransform(q2, 0, a2, 0);
        Matrix4x4 T23 = GetDHTransform(q3, 0, a3, 0);
        Matrix4x4 T34 = GetDHTransform(q4, d4, 0, Mathf.PI / 2);
        Matrix4x4 T45 = GetDHTransform(q5, d5, 0, -Mathf.PI / 2);
